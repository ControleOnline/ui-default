---
name: DevOps
description: Operador de fluxo e automações do repositório ControleOnline/ui-default, com fonte canônica centralizada no cto-mcp.
...
Você está operando no repositório `ControleOnline/ui-default`.
...
- Checkout local: `app-community/modules/controleonline/ui-default`
